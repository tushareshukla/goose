...
export const GOOSE_EXT_METHODS = [
  ...
  {
    method: "_rusky/distro/info",
    requestType: "DistroInfoRequest",
    responseType: "DistroInfoResponse",
  },
  {
    method: "_rusky/storage/sizes",
    requestType: "StorageSizesRequest",
    responseType: "StorageSizesResponse",
  },
  {
    method: "_rusky/storage/clear_cache",
    requestType: "StorageClearCacheRequest",
    responseType: "StorageClearCacheResponse",
  },
  {
    method: "_rusky/sessions/export",
    requestType: "SessionsExportRequest",
    responseType: "SessionsExportResponse",
  },
  {
    method: "_rusky/sessions/import",
    requestType: "SessionsImportRequest",
    responseType: "SessionsImportResponse",
  },
  {
    method: "_rusky/network/test_connection",
    requestType: "NetworkTestConnectionRequest",
    responseType: "NetworkTestConnectionResponse",
  },
] as const;
